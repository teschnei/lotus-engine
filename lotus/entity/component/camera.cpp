...
{
CameraComponent::CameraComponent(Entity* _entity, Engine* _engine) : Component(_entity, _engine) {}

Task<> CameraComponent::init() { co_return; }
...
bool CameraComponent::updated() { return updated_tick; }
...
glm::mat4 CameraComponent::getViewMatrix() { return view; }

glm::mat4 CameraComponent::getProjMatrix() { return projection; }

float CameraComponent::getNearClip() { return near_clip; }

float CameraComponent::getFarClip() { return far_clip; }
