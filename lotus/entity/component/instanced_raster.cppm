...
export module lotus:entity.component.instanced_raster;
...
WorkerTask<> InstancedRasterComponent::init()
{
    ...
    {
        vk::CommandBufferAllocateInfo alloc_info{.commandPool = *engine->renderer->graphics_pool,
...
void InstancedRasterComponent::drawShadowmapsToBuffer(vk::CommandBuffer command_buffer, uint32_t image)
{
    ...
    command_buffer.begin(
        {.flags = vk::CommandBufferUsageFlagBits::eSimultaneousUse | vk::CommandBufferUsageFlagBits::eRenderPassContinue, .pInheritanceInfo = &inheritInfo});
