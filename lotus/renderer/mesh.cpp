...
void lotus::Mesh::setVertexBuffer(uint8_t* buffer, size_t len)
{
    ...
    // auto stagingBuffer = memoryManager.get_memory(bufferSize, vk::BufferUsageFlagBits::eTransferSrc,
    ...
    // vertexBuffer = createBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_VERTEX_BUFFER_BIT,
