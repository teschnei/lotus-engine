...
namespace lotus
{
    ...
    private:
        ...
        static vk::UniqueDescriptorSetLayout initializeInputOutputDescriptorSetLayout(Renderer* renderer, std::span<vk::DescriptorSetLayoutBinding> input_output_descriptor_layout);
