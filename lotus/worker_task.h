...
namespace lotus
{
template <typename Result = void> struct WorkerTask;
...
template <typename Result> struct WorkerPromise : public WorkerPromise_base
{
...
template <> struct WorkerPromise<void> : public WorkerPromise_base
{
...
template <typename Result> struct WorkerTask
{
