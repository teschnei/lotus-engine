...
namespace lotus
{
    ...
    void RenderableEntityInitTask::createBuffers(WorkerThread* thread, RenderableEntity* _entity)
    {
        ...
        {
            _entity->uniform_buffers.push_back(thread->engine->renderer.memory_manager->GetBuffer(sizeof(RenderableEntity::UniformBufferObject), vk::BufferUsageFlagBits::eUniformBuffer, vk::MemoryPropertyFlagBits::eHostVisible | vk::MemoryPropertyFlagBits::eHostCoherent));
        }
    }
}
