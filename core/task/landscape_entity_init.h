...
namespace lotus
{
    ...
    private:
        void drawModel(WorkerThread* thread, vk::CommandBuffer buffer, Texture& texture, vk::Buffer uniform_buffer);
        void drawPiece(WorkerThread* thread, vk::CommandBuffer buffer, Model& model, Texture& texture, vk::Buffer uniform_buffer, vk::DeviceSize count);
