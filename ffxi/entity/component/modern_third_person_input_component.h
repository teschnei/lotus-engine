...
namespace FFXI
{
    class ModernThirdPersonInputComponent : public lotus::Component::Component<ModernThirdPersonInputComponent, ActorComponent, lotus::Component::AnimationComponent>
    {
    public:
