...
ThirdPersonFFXICameraComponent::ThirdPersonFFXICameraComponent(lotus::Entity* _entity, lotus::Input* _input, std::weak_ptr<lotus::Entity>& _focus) : InputComponent(_entity, _input), focus(_focus)
{
}
